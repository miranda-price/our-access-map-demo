...
function find_route(event) {
    ...
    // define edges
    BR00_BR01 = new Edge('floor', 'BR00_BR01', 1, true, true, false, false, false, 'Move from ground floor to 1st floor', 'Move from 1st floor to ground floor', null, null, 'Burton');
    BR00_BR02 = new Edge('floor', 'BR00_BR02', 2, true, true, false, false, false, 'Move from ground floor to 2nd floor', 'Move from 2nd floor to ground floor', null, null, 'Burton');
    BR00_BR03 = new Edge('floor', 'BR00_BR03', 3, true, true, false, false, false, 'Move from ground floor to 3rd floor', 'Move from 3rd floor to gorund floor', null, null, 'Burton');
    BR01_BR02 = new Edge('floor', 'BR01_BR02', 1, true, true, false, false, false, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', null, null, 'Burton');
    BR01_BR03 = new Edge('floor', 'BR01_BR03', 2, true, true, false, false, false, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', null, null, 'Burton');
    BR00_BR00A = new Edge('level', 'BR00_BR00A', 0, false, false, false, false, true, null, null, null, null, 'Burton');
    BR01_BR01A = new Edge('level', 'BR01_BR01A', 0, false, false, false, false, true, null, null, null, null, 'Burton');
    BR01_BR01B = new Edge('level', 'BR01_BR01B', 0, false, false, false, false, true, null, null, null, null, 'Burton');
    BR01_BR01C = new Edge('level', 'BR01_BR01C', 0, false, false, false, false, true, null, null, null, null, 'Burton');
    RT01_RT02 = new Edge('floor', 'RT01_RT02', 1, false, false, false, false, true, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', ['broken elevator in Morey/Rettner Hall'], null, 'Rettner');
    RT01_RT03 = new Edge('floor', 'RT01_RT03', 2, false, false, false, false, true, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator in Morey/Rettner Hall'], null, 'Rettner');
    RT02_RT03 = new Edge('floor', 'RT02_RT03', 1, false, false, false, false, true, 'Move from 2nd floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator in Morey/Rettner Hall'], null, 'Rettner');
    RT01_RT01A = new Edge('level', 'RT01_RT01A', 0, false, false, false, false, true, null, null, null, null, 'Rettner');
    RT01_RT01B = new Edge('level', 'RT01_RT01B', 0, false, false, false, false, true, null, null, null, null, 'Rettner');
    RT01_RT01C = new Edge('level', 'RT01_RT01C', 0, false, false, false, false, true, null, null, null, null, 'Rettner');
    MRG_MR01 = new Edge('floor', 'MRG_MR01', 1, false, false, false, false, true, 'Move from ground floor to 1st floor', 'Move from 1st floor to ground floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MRG_MR02 = new Edge('floor', 'MRG_MR02', 2, false, false, false, false, true, 'Move from ground floor to 2nd floor', 'Move from 2nd floor to ground floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MRG_MR03 = new Edge('floor', 'MRG_MR03', 3, false, false, false, false, true, 'Move from ground floor to 3rd floor', 'Move from 3rd floor to ground floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MRG_MR04 = new Edge('floor', 'MRG_MR04', 4, false, false, false, false, true, 'Move from ground floor to 4th floor', 'Move from 4th floor to ground floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MRG_MR05 = new Edge('floor', 'MRG_MR05', 5, false, false, false, false, true, 'Move from ground floor to 5th floor', 'Move from 5th floor to ground floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR01_MR02 = new Edge('floor', 'MR01_MR02', 1, false, false, false, false, true, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR01_MR03 = new Edge('floor', 'MR01_MR03', 2, false, false, false, false, true, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR01_MR04 = new Edge('floor', 'MR01_MR04', 3, false, false, false, false, true, 'Move from 1st floor to 4th floor', 'Move from 4th floor to 1st floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR01_MR05 = new Edge('floor', 'MR01_MR05', 4, false, false, false, false, true, 'Move from 1st floor to 5th floor', 'Move from 5th floor to 1st floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR02_MR03 = new Edge('floor', 'MR02_MR03', 1, false, false, false, false, true, 'Move from 2nd floor to 3rd floor', 'Move from 3rd floor to 2ndfloor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR02_MR04 = new Edge('floor', 'MR02_MR04', 2, false, false, false, false, true, 'Move from 2nd floor to 4th floor', 'Move from 4th floor to 2nd floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR02_MR05 = new Edge('floor', 'MR02_MR05', 3, false, false, false, false, true, 'Move from 2nd floor to 5th floor', 'Move from 5th floor to 2nd floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR03_MR04 = new Edge('floor', 'MR03_MR04', 1, false, false, false, false, true, 'Move from 3rd floor to 4th floor', 'Move from 4th floor to 3rd floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR03_MR05 = new Edge('floor', 'MR03_MR05', 2, false, false, false, false, true, 'Move from 3rd floor to 5th floor', 'Move from 5th floor to 3rd floor', ['broken elevator in Morey Hall'], null, 'Morey');
    MR02_MR02A = new Edge('level', 'MR02_MR02A', 0, false, false, false, false, true, null, null, null, null, 'Morey');
    MR03_MR03A = new Edge('level', 'MR03_MR03A', 0, false, false, false, false, true, null, null, null, null, 'Morey');
    MR03_MR03B = new Edge('level', 'MR03_MR03B', 0, false, false, false, false, true, null, null, null, null, 'Morey');
    MR03_MR03C = new Edge('level', 'MR03_MR03C', 0, false, false, false, false, true, null, null, null, null, 'Morey');
    MRG_RT01 = new Edge('connection', 'MRG_RT01', 0, false, false, false, false, true, 'Exit the separate elevator area to enter floor 1 of Rettner', 'Enter the separate elevator area between Rettner and Morey', ['broken push door button from Rettner 1 to Morey elevator'], [[43.1284174, -77.6299371]], 'Morey/Rettner');
    MR01_RT01 = new Edge('connection', 'MR01_RT01', 0, true, true, false, false, false, 'Go down the steps to the right of the elevator to enter floor 1 of Rettner', 'Go up the steps next to the separate elevator area to enter floor 1 of Morey', null, [[43.1284231, -77.6299252]], 'Morey/Rettner');
    MR02_RT02 = new Edge('connection', 'MR02_RT02', 0, false, false, false, false, true, 'Take a right before the elevator to enter floor 2 of Rettner', 'Go past the lounge area and through the open doorway to enter floor 2 of Morey', null, [[43.1284231, -77.6299252]], 'Morey/Rettner');
    MR03_RT03 = new Edge('connection', 'MR03_RT03', 0, false, false, false, false, true, 'Take a right before the elevator to enter floor 3 of Rettner', 'Go past the audio/visual studio and lounge area to enter floor 3 of Morey', null, [[43.1284231, -77.6299252]], 'Morey/Rettner');
    RRG_RR01 = new Edge('floor', 'RRG_RR01', 1, false, false, false, false, true, 'Move from the ground floor to the 1st floor', 'Move from the 1st floor to the ground floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RRG_RR02 = new Edge('floor', 'RRG_RR02', 2, false, false, false, false, true, 'Move from the ground floor to the 2nd floor', 'Move from the 2nd floor to the ground floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RRG_RR03 = new Edge('floor', 'RRG_RR03', 3, false, false, false, false, true, 'Move from the ground floor to the 3rd floor', 'Move from the 3rd floor to the ground floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RRG_RR04 = new Edge('floor', 'RRG_RR04', 4, false, false, false, false, true, 'Move from the ground floor to the 4th floor', 'Move from the 4th floor to the ground floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RR01_RR02 = new Edge('floor', 'RR01_RR02', 1, false, false, false, false, true, 'Move from the 1st floor to the 2nd floor', 'Move from the 2nd floor to the 1st floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RR01_RR03 = new Edge('floor', 'RR01_RR03', 2, false, false, false, false, true, 'Move from the 1st floor to the 3rd floor', 'Move from the 3rd floor to the 1st floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RR01_RR04 = new Edge('floor', 'RR01_RR04', 3, false, false, false, false, true, 'Move from the 1st floor to the 4th floor', 'Move from the 4th floor to the 1st floor', ['broken silver elevator in Rush Rhees', 'broken green elevator in Rush Rhees', ' broken blue elevator in Rush Rhees', ' broken yellow elevator in Rush Rhees'], null, 'Rush Rhees');
    RRG_RRGA = new Edge('level', 'RRG_RRGA', 0, false, false, false, false, true, null, null, null, null, 'Rush Rhees');
    RRG_RRGB = new Edge('level', 'RRG_RRGB', 0, false, false, false, false, true, null, null, null, null, 'Rush Rhees');
    RRG_RRGC = new Edge('level', 'RRG_RRGC', 0, false, false, false, false, true, null, null, null, null, 'Rush Rhees');
    RR01_RR01A = new Edge('level', 'RR01_RR01A', 0, false, false, false, false, true, null, null, null, null, 'Rush Rhees');
    RR01_RR01B = new Edge('level', 'RR01_RR01B', 0, false, false, false, false, true, null, null, null, null, 'Rush Rhees');
    MR02A_RRGC = new Edge('tunnel', 'MR02A_RRGC', null, false, false, false, false, true, 'Go through the double doors to exit Morey; take a right at the end of the hall; continue through the tunnel and enter the ground floor of Rush Rhees', 'Turn right by the vending machines and staircase; follow the tunnel; go past the tunnel to Starbucks and go through the double doors on the right at the end of the tunnel to enter 2nd floor of Morey', ['broken push door button entering Morey/Rush Rhees tunnel'], [[43.1284964, -77.6293734],[43.128453, -77.6293403],[43.1285122, -77.6291817],[43.128488, -77.6291669],[43.1285151, -77.6290934]], 'Morey/Rush Rhees');
    ...
    BL01_BL02 = new Edge('floor', 'BL01_BL02', 1, false, false, false, false, true, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', ['broken elevator in Bausch & Lomb Hall'], null, 'Bausch & Lomb');
    BL01_BL03 = new Edge('floor', 'BL01_BL03', 2, false, false, false, false, true, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator in Bausch & Lomb Hall'], null, 'Bausch & Lomb');
    BL01_BL04 = new Edge('floor', 'BL01_BL04', 3, false, false, false, false, true, 'Move from 1st floor to 4th floor', 'Move from 4th floor to 1st floor', ['broken elevator in Bausch & Lomb Hall'], null, 'Bausch & Lomb');
    BL01_BL05 = new Edge('floor', 'BL01_BL05', 4, true, true, false, false, false, 'Move from 1st floor to 5th floor', 'Move from 5th floor to 1st floor', null, null, 'Bausch & Lomb');
    BL02_BL03 = new Edge('floor', 'BL02_BL03', 1, false, false, false, false, true, 'Move from 2nd floor to 3rd floor', 'Move from 3rd floor to 2nd floor', ['broken elevator in Bausch & Lomb Hall'], null, 'Bausch & Lomb');
    BL02_BL04 = new Edge('floor', 'BL02_BL04', 2, false, false, false, false, true, 'Move from 2nd floor to 4th floor', 'Move from 4th floor to 2nd floor', ['broken elevator in Bausch & Lomb Hall'], null, 'Bausch & Lomb');
    BL02_BL05 = new Edge('floor', 'BL02_BL05', 3, true, true, false, false, false, 'Move from 2nd floor to 5th floor', 'Move from 5th floor to 2nd floor', null, null, 'Bausch & Lomb');
    BL01_BL01A = new Edge('level', 'BL01_BL01A', 0, false, false, false, false, true, null, null, null, null, 'Bausch & Lomb');
    BL01_BL01B = new Edge('level', 'BL01_BL01B', 0, false, false, false, false, true, null, null, null, null, 'Bausch & Lomb');
    BL01_BL01C = new Edge('level', 'BL01_BL01C', 0, false, false, false, false, true, null, null, null, null, 'Bausch & Lomb');
    BL02_BL02A = new Edge('level', 'BL02_BL02A', 0, false, false, false, false, true, null, null, null, null, 'Bausch & Lomb');
    DWB_DW01 = new Edge('floor', 'DWB_DW01', 1, false, false, false, true, false, 'Move from basement to 1st floor', 'Move from 1st floor to basement', ['broken elevator on south side of Dewey Hall'], null, 'Dewey');
    DW01_DW02 = new Edge('floor', 'DW01_DW02', 1, false, false, false, false, true, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW01_DW03 = new Edge('floor', 'DW01_DW03', 2, false, false, false, false, true, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW01_DW04 = new Edge('floor', 'DW01_DW04', 3, false, false, false, false, true, 'Move from 1st floor to 4th floor', 'Move from 4th floor to 1st floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW01_DW05 = new Edge('floor', 'DW01_DW05', 4, true, true, false, false, false, 'Move from 1st floor to 5th floor', 'Move from 5th floor to 1st floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW02_DW03 = new Edge('floor', 'DW02_DW03', 1, false, false, false, false, true, 'Move from 2nd floor to 3rd floor', 'Move from 3rd floor to 2nd floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW02_DW04 = new Edge('floor', 'DW02_DW04', 2, false, false, false, false, true, 'Move from 2nd floor to 4th floor', 'Move from 4th floor to 2nd floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW02_DW05 = new Edge('floor', 'DW02_DW05', 3, true, true, false, false, false, 'Move from 2nd floor to 5th floor', 'Move from 5th floor to 2nd floor', ['broken elevator on north side of Dewey Hall'], null, 'Dewey');
    DW01_DW01A = new Edge('level', 'DW01_DW01A', 0, false, false, false, false, true, null, null, null, null, 'Dewey');
    DW01_DW01B = new Edge('level', 'DW01_DW01B', 0, false, false, false, false, true, null, null, null, null, 'Dewey');
    DW01_DW01C = new Edge('level', 'DW01_DW01C', 0, false, false, false, false, true, null, null, null, null, 'Dewey');
    DW01_DW01D = new Edge('level', 'DW01_DW01D', 0, false, false, false, false, true, null, null, null, null, 'Dewey');
    DW02_DW02A = new Edge('level', 'DW02_DW02A', 0, false, false, false, false, true, null, null, null, null, 'Dewey');
    HT01_HT02 = new Edge('floor', 'HT01_HT02', 1, true, true, false, false, false, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', null, null, 'Hoyt');
    HT01_HT01A = new Edge('level', 'HT01_HT01A', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT01_HT01B = new Edge('level', 'HT01_HT01B', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT01_HT01C = new Edge('level', 'HT01_HT01C', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT01_HT01D = new Edge('level', 'HT01_HT01D', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT01_HT01E = new Edge('level', 'HT01_HT01E', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT01_HT01F = new Edge('level', 'HT01_HT01F', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    HT02_HT02A = new Edge('level', 'HT02_HT02A', 0, false, false, false, false, true, null, null, null, null, 'Hoyt');
    LT01_LT02 = new Edge('floor', 'LT01_LT02', 1, false, false, false, true, false, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT01_LT03 = new Edge('floor', 'LT01_LT03', 2, false, false, false, true, false, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT01_LT04 = new Edge('floor', 'LT01_LT04', 3, false, false, false, true, false, 'Move from 1st floor to 4th floor', 'Move from 4th floor to 1st floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT01_LT05 = new Edge('floor', 'LT01_LT05', 4, false, false, false, true, false, 'Move from 1st floor to 5th floor', 'Move from 5th floor to 1st floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT02_LT03 = new Edge('floor', 'LT02_LT03', 1, false, false, false, true, false, 'Move from 2nd floor to 3rd floor', 'Move from 3rd floor to 2nd floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT02_LT04 = new Edge('floor', 'LT02_LT04', 2, false, false, false, true, false, 'Move from 2nd floor to 4th floor', 'Move from 4th floor to 2nd floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT02_LT05 = new Edge('floor', 'LT02_LT05', 3, false, false, false, true, false, 'Move from 2nd floor to 5th floor', 'Move from 5th floor to 2nd floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT03_LT04 = new Edge('floor', 'LT03_LT04', 1, false, false, false, true, false, 'Move from 3rd floor to 4th floor', 'Move from 4th floor to 3rd floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT03_LT05 = new Edge('floor', 'LT03_LT05', 2, false, false, false, true, false, 'Move from 3rd floor to 5th floor', 'Move from 5th floor to 3rd floor', ['broken elevator in Lattimore Hall'], null, 'Lattimore');
    LT01_LT01A = new Edge('level', 'LT01_LT01A', 0, false, false, false, false, true, null, null, null, null, 'Lattimore');
    LT02_LT02A = new Edge('level', 'LT02_LT02A', 0, false, false, false, false, true, null, null, null, null, 'Lattimore');
    LT03_LT03A = new Edge('level', 'LT03_LT03A', 0, false, false, false, false, true, null, null, null, null, 'Lattimore');
    IF01_IF02 = new Edge('floor', 'IF01_IF02', 1, false, false, false, false, true, 'Move from 1st floor to 2nd floor', 'Move from 2nd floor to 1st floor', null, null, 'Interfaith Chapel');
    IF01_IF03 = new Edge('floor', 'IF01_IF03', 2, false, false, false, false, true, 'Move from 1st floor to 3rd floor', 'Move from 3rd floor to 1st floor', null, null, 'Interfaith Chapel');
    IF02_IF03 = new Edge('floor', 'IF02_IF03', 1, false, false, false, false, true, 'Move from 2nd floor to 1st floor', 'Move from 3rd floor to 2nd floor', null, null, 'Interfaith Chapel');
    IF01_IF01A = new Edge('level', 'IF01_IF01A', 0, false, false, false, false, true, null, null, null, null, 'Interfaith Chapel');
    IF01_IF01B = new Edge('level', 'IF01_IF01B', 0, false, false, false, false, true, null, null, null, null, 'Interfaith Chapel');
    IF03_IF03A = new Edge('level', 'IF03_IF03A', 0, false, false, false, false, true, null, null, null, null, 'Interfaith Chapel');
    ...
    BL01A_RRGB = new Edge('tunnel', 'BL01A_RRGB', null, true, true, true, false, false, 'Enter the tunnels; take the left door at the end of the hall; follow the tunnel; go through the door marked Rush Rhees', 'Go through the door to enter the tunnel; follow the tunnel; take a right after the next door; enter the main tunnel area', null, [[43.1279425,  -77.6290296],[43.1279647,  -77.6290445],[43.1279875,  -77.6289774],[43.1280148,  -77.6289992],[43.1280951,  -77.6287784]], 'Bausch & Lomb/Rush Rhees');
    ...
    RRGB = new Node('Rush Rhees', 'G', 'RRGB', [RRG_RRGB, BL01A_RRGB], 'entrance', [43.1281014, -77.6287809], Math.min(), []);
    ...
    BL01A = new Node('Bausch & Lomb', '1', 'BL01A', [BL01_BL01A, BL01A_RRGB], 'entrance', [43.1277064, -77.6296434], Math.min(), []);
