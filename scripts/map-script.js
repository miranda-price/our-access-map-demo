...
function find_route(event) {
    ...
    EQPAK_RT01B = new Edge('path', 'EQPAK_RT01B', null, false, false, false, false, true, 'move along Morey and enter 1st floor of Rettner', 'leave 1st floor of Rettner and move along Morey', null, [[43.1288719,  -77.6291943],[43.1284505,  -77.6299049]], 'Wilson Quad');
    EQPAJ_EQPAL = new Edge('path', 'EQPAJ_EQPAL', null, false, false, false, false, true, 'move towards Morey Hall', 'move away from Morey Hall', null, [[43.1286454,  -77.6289473],[43.1285401,  -77.6292292]], 'Eastman Quad');
    EQPAL_WC03B = new Edge('path', 'EQPAL_WC03B', null, false, false, false, false, true, 'enter 3rd floor of Wilson Commons', 'leave 3rd floor of Wilson Commons', null, [[43.1285401,  -77.6292292],[43.1288564,  -77.6294336]], 'Eastman Quad');
    EQPAL_EQPE = new Edge('path', 'EQPAL_EQPE', null, false, false, false, false, true, 'move to corner of Eastman Quad', 'move away from Eastman Quad', null, [[43.1285401,  -77.6292292],[43.1285274,  -77.6292554],[43.1284752,  -77.6292172]], 'Eastman Quad');
    EQPAH_EQPAJ = new Edge('path', 'EQPAH_EQPAJ', null, false, false, false, false, true, 'move alongside Rush Rhees', 'move alongside Rush Rhees', null, [[43.1287427,  -77.6286916],[43.1286454,  -77.6289473]], 'Eastman Quad');
    EQPAI_EQPAI = new Edge('path', 'EQPAI_EQPAI', null, false, false, false, false, true, 'move towards Morey Hall', 'move away from Morey Hall', null, [[43.1287427,  -77.6286916],[43.1286773,  -77.6288577]], 'Eastman Quad');
    DG02B_EQPAI = new Edge('path', 'DG02B_EQPAI', null, false, false, false, false, true, 'leave 2nd floor of Douglass', 'enter 2nd floor of Douglass', ['broken push door button entering 2nd floor of Douglass'], [[43.1289347,  -77.6290367],[43.1286773,  -77.6288577]], 'Eastman Quad');
    DG02A_EQPAH = new Edge('path', 'DG02A_EQPAH', null, false, false, false, false, true, 'leave 2nd floor of Douglass', 'enter 2nd floor of Douglass', null, [[43.1290874,  -77.6286397],[43.1287427,  -77.6286916]], 'Eastman Quad');
    EQPAJ_EQPAK = new Edge('path', 'EQPAJ_EQPAK', null, true, true, false, false, false, 'go down the stairs and move to the center of the plaza', 'leave the plaza and go up the stairs', null, [[43.1286454,  -77.6289473],[43.128816,  -77.6290697],[43.1285401,  -77.6292292]], 'Eastman Quad');
    EQPAF_EQPAG = new Edge('path', 'EQPAF_EQPAG', null, false, false, false, false, true, 'move away from Rush Rhees', 'move alongside Rush Rhees', null, [[43.1287332,  -77.6279317],[43.1289277,  -77.6280753]], 'Eastman Quad');
    EQPAG_EQPAH = new Edge('path', 'EQPAG_EQPAH', null, false, false, false, false, true, 'move alongside Rush Rhees', 'move alongside Rush Rhees', null, [[43.1289277,  -77.6280753],[43.128942,  -77.6281592],[43.1287427,  -77.6286916]], 'Eastman Quad');
    EQPAG_WQPO = new Edge('path', 'EQPAG_WQPO', null, false, false, false, false, true, 'move alongside Library Road until the entrance to Wilson Quad', 'move alongside Library Road until Rush Rhees', null, [[43.1279103,  -77.6293189],[43.128942,  -77.6281597],[43.1289727,  -77.6282071],[43.1293541,  -77.6284267],[43.1294526,  -77.6285519],[43.1296089,  -77.6285955],[43.1296668,  -77.6286361]], 'Library Road');       
    WQPM_WQPO = new Edge('path', 'WQPM_WQPO', null, false, false, false, false, true, 'move alongside Douglass and leave Wilson Quad', 'enter Wilson Quad and move alongside Douglass', null, [[43.1295769,  -77.6288789],[43.1296668,  -77.6286361]], 'Wilson Quad');
    WQPM_WQPN = new Edge('path', 'WQPM_WQPN', null, false, false, false, false, true, 'move alongside Douglass', 'move alongside Douglass', null, [[43.1295769,  -77.6288789],[43.1294828,  -77.6291499]], 'Wilson Quad');
    WQPK_WQPN = new Edge('path', 'WQPK_WQPN', null, false, false, false, false, true, 'move past the clock tower towards Wilson Commons', 'move past the clock tower towards Douglass', null, [[43.1293217,  -77.6295629],[43.1294828,  -77.6291499]], 'Wilson Quad');
    WQPK_WQPL = new Edge('path', 'WQPK_WQPL', null, true, true, false, false, false, 'go up the stairs to the beginning of the plaza', 'leave the plaza and go down the stairs', null, [[43.1293217,  -77.6295629],[43.1291335,  -77.6294231]], 'Wilson Quad');
    DG01A_WQPM = new Edge('path', 'DG01A_WQPM', null, false, false, false, false, true, 'leave Douglass and take curved path to the right', 'take a side path to bypass stairs and enter Douglass from the left', ['broken push door button entering 1st floor of Douglass'], [[43.1292479,  -77.6289777],[43.1293608,  -77.628735],[43.1292683,  -77.6289929],[43.1295769,  -77.6288789]], 'Wilson Quad');
    EQPAK_WQPL = new Edge('path', 'EQPAK_WQPL', null, false, false, false, false, false, 'move to the edge of the plaza by the front of Douglass', 'move to the center of the plaza', null, [[43.1288719,  -77.6291943],[43.1289073,  -77.6292663],[43.1291335,  -77.6294231]], 'Wilson Quad');
    WQPJ_WQPK = new Edge('path', 'WQPJ_WQPK', null, false, false, false, false, true, 'move towards the clock tower', 'move away from the clock tower', null, [[43.1292371,  -77.6297858],[43.1293217,  -77.6295629]], 'Wilson Quad');
    WQPI_WQPJ = new Edge('path', 'WQPI_WQPJ', null, false, false, false, false, true, 'move alongside Wilson Commons', 'move alongside Wilson Commons', null, [[43.1291383,  -77.6300524],[43.1292371,  -77.6297858]], 'Wilson Quad');
    WQPI_WQPP = new Edge('path', 'WQPI_WQPP', null, false, false, false, false, true, 'move along Wilson Commons stairs', 'move along Wilson Commons stairs', null, [[43.1291383,  -77.6300524],[43.1292371,  -77.6297858]], 'Wilson Quad');
    WQPC_WQPI = new Edge('path', 'WQPC_WQPI', null, false, false, false, false, true, 'move towards Wilson Commons', 'move away from Wilson Commons', null, [[43.1289216,  -77.6306342],[43.1291383,  -77.6300524]], 'Wilson Quad');
    WQPG_WQPQ = new Edge('path', 'WQPG_WQPQ', null, false, false, false, false, true, 'move alongside Rettner Hall towards Wilson Commons', 'move alongside Rettner Hall towards Lattimore', null, [[43.1285042,  -77.6303344],[43.1287193,  -77.6302396]], 'Wilson Quad');
    RT01A_WQPQ = new Edge('path', 'RT01A_WQPQ', null, false, false, false, false, true, 'leave 1st floor of Rettner', 'enter 1st floor of Rettner', ['broken push door button entering 1st floor of Rettner facing Crosby'], [[43.1286775,  -77.630216],[43.1287193,  -77.6302396]], 'Wilson Quad');
    WC02A_WQPP = new Edge('path', 'WC02A_WQPP', null, false, false, false, false, true, 'leave 2nd floor of Wilson Commons', 'enter 2nd floor of Wilson Commons', null, [[43.1289034,  -77.6300559],[43.128898,  -77.6301587]], 'Wilson Quad');
    WQPP_WQPQ = new Edge('path', 'WQPP_WQPQ', null, false, false, false, false, true, 'move away from Wilson Commons towards Rettner', 'move away from Rettner towards Wilson Commons', null, [[43.128898,  -77.6301587],[43.1287193,  -77.6302396]], 'Wilson Quad');
    DG01A_WQPN = new Edge('path', 'DG01A_WQPN', null, true, true, false, false, false, 'leave 1st floor of Douglass and go down the stairs', 'go up the stairs and enter 1st floor of Douglass', ['broken push door button entering 1st floor of Douglass'], [[43.1292479,  -77.6289777],[43.1294828,  -77.6291499]], 'Wilson Quad');
    WQPL_WQPN = new Edge('path', 'WQPL_WQPN', null, true, true, false, false, false, 'move to Douglass entrance turn left and go down the stairs', 'go up the stairs turn right and move the beginning of plaza between Douglass and Wilson Commons', null, [[43.1291335,  -77.6294231],[43.1293608,  -77.628735],[43.1294828,  -77.6291499]], 'Wilson Quad');
    WQPL_WQPM = new Edge('path', 'WQPL_WQPM', null, false, false, false, false, true, 'move just past the Douglass entrance and take curved path to the left', 'take a side path to bypass stairs turn right and move the beginning of plaza between Douglass and Wilson Commons', null, [[43.1291335,  -77.6294231],[43.1292683,  -77.6289929],[43.1295769,  -77.6288789]], 'Wilson Quad');
    
    var all_edges = [BR00_BR01, BR00_BR02, BR00_BR03, BR01_BR02, BR01_BR03, BR00_BR00A, BR01_BR01A, BR01_BR01B, BR01_BR01C, RT01_RT02, RT01_RT03, RT02_RT03, RT01_RT01A, RT01_RT01B, RT01_RT01C, MRG_MR01, MRG_MR02, MRG_MR03, MRG_MR04, MRG_MR05, MR01_MR02, MR01_MR03, MR01_MR04, MR01_MR05, MR02_MR03, MR02_MR04, MR02_MR05, MR03_MR04, MR03_MR05, MR02_MR02A, MR03_MR03A, MR03_MR03B, MR03_MR03C, MRG_RT01, MR01_RT01, MR02_RT02, MR03_RT03, RRG_RR01, RRG_RR02, RRG_RR03, RRG_RR04, RR01_RR02, RR01_RR03, RR01_RR04, RRG_RRGA, RRG_RRGB, RRG_RRGC, RR01_RR01A, RR01_RR01B, MR02A_RRGC, EQPC_MR03A, EQPB_MR03B, EQPA_MR03C, EQPA_EQPB, EQPB_EQPC, EQPD_RR01B, EQPD_EQPE, EQPD_EQPF, EQPC_EQPE, EQPB_EQPG, EQPF_EQPG, BR01A_WQPB, BR01B_WQPB, BR01B_WQPA, BR01C_WQPA, WQPA_WQPB, WQPA_WQPE, WQPB_WQPD, WQPE_WQPF, WQPC_WQPD, WQPC_WQPF, WQPC_WQPG, WQPG_WQPH, RT01A_WQPG, RT01C_WQPH, BL01_BL02, BL01_BL03, BL01_BL04, BL01_BL05, BL02_BL03, BL02_BL04, BL02_BL05, BL01_BL01A, BL01_BL01B, BL01_BL01C, BL02_BL02A, DWB_DW01, DW01_DW02, DW01_DW03, DW01_DW04, DW01_DW05, DW02_DW03, DW02_DW04, DW02_DW05, DW01_DW01A, DW01_DW01B, DW01_DW01C, DW01_DW01D, DW02_DW02A, HT01_HT02, HT01_HT01A, HT01_HT01B, HT01_HT01C, HT01_HT01D, HT01_HT01E, HT01_HT01F, HT02_HT02A, LT01_LT02, LT01_LT03, LT01_LT04, LT01_LT05, LT02_LT03, LT02_LT04, LT02_LT05, LT03_LT04, LT03_LT05, LT01_LT01A, LT02_LT02A, LT03_LT03A, IF01_IF02, IF01_IF03, IF02_IF03, IF01_IF01A, IF01_IF01B, IF03_IF03A, EQPJ_LT03A, EQPO_LT02A, EQPO_MR02B, EQPO_EQPP, EQPH_EQPI, EQPA_EQPI, EQPG_EQPH, EQPI_EQPJ, EQPH_EQPK, EQPJ_EQPN, EQPK_EQPL, EQPJ_EQPK, EQPM_EQPN, EQPL_EQPM, EQPM_IF03A, BL02A_EQPG, DW02A_EQPK, EQPG_EQPJ, EQPB_EQPK, EQPB_EQPD, EQPD_EQPG, EQPJ_EQPM, EQPK_EQPM, EQPP_HT01A, EQPR_HT01B, EQPQ_HT01E, EQPQ_HT01F, EQPR_HT02A, EQPQ_HT02A, BL01A_RRGB, BL01B_EQPR, BL01C_EQPP, DW01A_EQPP, DW01B_EQPQ, ML01_ML02, ML01_ML03, ML02_ML03, ML02_ML04, ML03_ML04, ML02_ML02A, ML02_ML02B, ML03_ML03A, ML03_ML03B, EQPAB_EQPQ, EQPAA_EQPR, EQPAA_EQPAB, EQPAA_EQPZ, EQPS_EQPT, EQPS_EQPZ, EQPS_EQPV, EQPU_EQPV, EQPV_EQPW, EQPW_EQPY, EQPU_EQPX, EQPU_EQPY, EQPX_EQPAE, EQPAC_EQPAE, EQPT_ML03B, EQPAC_ML02B, EQPAD_ML03A, EQPX_EQPY, EQPF_EQPV, EQPF_EQPW, EQPAF_RRGA, EQPAF_EQPY, EQPAE_EQPT, ML02A_RRGB, BL01A_ML02A, DG01_DG02, DG01_DG03, DG01_DG04, DG02_DG03, DG02_DG04, DG03_DG04, DG01_DG01A, DG02_DG02A, DG02_DG02B, DG02_DG02C, DG03_DG03A, WC01_WC02, WC01_WC03, WC01_WC04, WC01_WC05, WC02_WC03, WC02_WC04, WC02_WC05, WC03_WC04, WC03_WC05, WC04_WC05, WC02_WC02A, WC02_WC02B, WC03_WC03A, WC03_WC03B, WC04_WC04A, DG02C_WC03A, RRGC_WC03B, DG03A_RR01A, HUB_HU01, HU01_HU02, HU01_HU03, HU01_HU04, HU02_HU03, HU02_HU04, HL01_HL02, HL01_HL03, HL01_HL04, HL01_HL05, HL01_HL06, HL01_HL07, HL01_HL08, HL01_HL09, HL01_HL10, HL01_HL11, HL02_HL03, HL02_HL04, HL02_HL05, HL02_HL06, HL02_HL07, HL02_HL08, HL02_HL09, HL02_HL10, HL02_HL11, HU01_HU01A, HU02_HU02A, HL01_HL01A, HL02_HL02A, SQPA_SQPW, SQPV_SQPW, SQPA_SQPC, SQPB_SQPC, SQPB_SQPE, SQPE_SQPF, SQPB_SQPG, SQPB_SQPD, SQPD_SQPM, SQPM_SQPN, SQPG_SQPM, SQPG_SQPH, SQPG_SQPJ, SQPJ_SQPK, SQPK_SQPL, SQPH_SQPI, SQPI_SQPJ, SQPI_SQPS, SQPR_SQPS, SQPQ_SQPR, SQPO_SQPQ, SQPO_SQPP, SQPP_SQPT, SQPT_SQPU, SQPM_SQPU, EQPQ_SQPV, EQPAB_SQPV, GR01A_SQPE, SQPF_WM01A, GR01C_SQPH, GR01B_SQPR, SQPO_SQPX, SQPJ_SQPX, CS02A_SQPX, CL02A_SQPX, HL02A_SQPL, SQPL_SQPY, SQPY_SQPZ, SQPN_SQPZ, HU01A_SQPZ, HL01A_SQPZ, GR01_WM01, GR02_WM02, GR03_WM03, GR04_WM04, GR05_WM05, CS02_CS04, CS02_CS05, CS02_CS06, CS02_CS07, CL01_CL02, CL01_CL03, CL02_CL03, GR01_GR02, GR01_GR03, GR01_GR04, GR01_GR05, GR02_GR03, GR02_GR04, GR02_GR05, WM01_WM02, WM01_WM03, WM01_WM04, WM01_WM05, CS02_CS02A, CL01_CL01A, CL01_CL01B, CL01_CL01C, CL02_CL02A, CL03_CL03A, GR01_GR01A, GR01_GR01B, GR01_GR01C, GR02_GR02A, WM01_WM01A, EQPAK_RT01B, EQPAJ_EQPAL, EQPAL_WC03B, EQPAL_EQPE, EQPAH_EQPAJ, EQPAI_EQPAI, DG02B_EQPAI, DG02A_EQPAH, EQPAJ_EQPAK, EQPAF_EQPAG, EQPAG_EQPAH, EQPAG_WQPO, WQPM_WQPO, WQPM_WQPN, WQPK_WQPN, WQPK_WQPL, DG01A_WQPM, EQPAK_WQPL, WQPJ_WQPK, WQPI_WQPJ, WQPI_WQPP, WQPC_WQPI, WQPG_WQPQ, RT01A_WQPQ, WC02A_WQPP, WQPP_WQPQ, DG01A_WQPN, WQPL_WQPN, WQPL_WQPM]
    var edges_find_lengths = [MR02A_RRGC, EQPC_MR03A, EQPB_MR03B, EQPA_MR03C, EQPA_EQPB, EQPB_EQPC, EQPD_RR01B, EQPD_EQPE, EQPD_EQPF, EQPC_EQPE, EQPB_EQPG, EQPF_EQPG, BR01A_WQPB, BR01B_WQPB, BR01B_WQPA, BR01C_WQPA, WQPA_WQPB, WQPA_WQPE, WQPB_WQPD, WQPE_WQPF, WQPC_WQPD, WQPC_WQPF, WQPC_WQPG, WQPG_WQPH, RT01A_WQPG, RT01C_WQPH, EQPJ_LT03A, EQPO_LT02A, EQPO_MR02B, EQPO_EQPP, EQPH_EQPI, EQPA_EQPI, EQPG_EQPH, EQPI_EQPJ, EQPH_EQPK, EQPJ_EQPN, EQPK_EQPL, EQPJ_EQPK, EQPM_EQPN, EQPL_EQPM, EQPM_IF03A, BL02A_EQPG, DW02A_EQPK, EQPG_EQPJ, EQPB_EQPK, EQPB_EQPD, EQPD_EQPG, EQPJ_EQPM, EQPK_EQPM, EQPP_HT01A, EQPR_HT01B, EQPQ_HT01E, EQPQ_HT01F, EQPR_HT02A, EQPQ_HT02A, BL01A_RRGB, BL01B_EQPR, BL01C_EQPP, DW01A_EQPP, DW01B_EQPQ, EQPAB_EQPQ, EQPAA_EQPR, EQPAA_EQPAB, EQPAA_EQPZ, EQPS_EQPT, EQPS_EQPZ, EQPS_EQPV, EQPU_EQPV, EQPV_EQPW, EQPW_EQPY, EQPU_EQPX, EQPU_EQPY, EQPX_EQPAE, EQPAC_EQPAE, EQPT_ML03B, EQPAC_ML02B, EQPAD_ML03A, EQPX_EQPY, EQPF_EQPV, EQPF_EQPW, EQPAF_RRGA, EQPAF_EQPY, EQPAE_EQPT, ML02A_RRGB, BL01A_ML02A, DG02C_WC03A, RRGC_WC03B, DG03A_RR01A, SQPA_SQPW, SQPV_SQPW, SQPA_SQPC, SQPB_SQPC, SQPB_SQPE, SQPE_SQPF, SQPB_SQPG, SQPB_SQPD, SQPD_SQPM, SQPM_SQPN, SQPG_SQPM, SQPG_SQPH, SQPG_SQPJ, SQPJ_SQPK, SQPK_SQPL, SQPH_SQPI, SQPI_SQPJ, SQPI_SQPS, SQPR_SQPS, SQPQ_SQPR, SQPO_SQPQ, SQPO_SQPP, SQPP_SQPT, SQPT_SQPU, SQPM_SQPU, EQPQ_SQPV, EQPAB_SQPV, GR01A_SQPE, SQPF_WM01A, GR01C_SQPH, GR01B_SQPR, SQPO_SQPX, SQPJ_SQPX, CS02A_SQPX, CL02A_SQPX, HL02A_SQPL, SQPL_SQPY, SQPY_SQPZ, SQPN_SQPZ, HU01A_SQPZ, HL01A_SQPZ, GR01_WM01, GR02_WM02, GR03_WM03, GR04_WM04, GR05_WM05, EQPAK_RT01B, EQPAJ_EQPAL, EQPAL_WC03B, EQPAL_EQPE, EQPAH_EQPAJ, EQPAI_EQPAI, DG02B_EQPAI, DG02A_EQPAH, EQPAJ_EQPAK, EQPAF_EQPAG, EQPAG_EQPAH, EQPAG_WQPO, WQPM_WQPO, WQPM_WQPN, WQPK_WQPN, WQPK_WQPL, DG01A_WQPM, EQPAK_WQPL, WQPJ_WQPK, WQPI_WQPJ, WQPI_WQPP, WQPC_WQPI, WQPG_WQPQ, RT01A_WQPQ, WC02A_WQPP, WQPP_WQPQ, DG01A_WQPN, WQPL_WQPN, WQPL_WQPM]
    ...
    EQPAG = new Node('Eastman Quad', null, 'EQPAG', [EQPAF_EQPAG, EQPAG_EQPAH, EQPAG_WQPO], 'intersection', [43.1289277, -77.6280753], Math.min(), []);
    EQPAH = new Node('Eastman Quad', null, 'EQPAH', [EQPAH_EQPAJ, DG02A_EQPAH, EQPAG_EQPAH], 'intersection', [43.1287427, -77.6286916], Math.min(), []);
    EQPAI = new Node('Eastman Quad', null, 'EQPAI', [EQPAI_EQPAI, EQPAI_EQPAI, DG02B_EQPAI], 'intersection', [43.1286773, -77.6288577], Math.min(), []);
    EQPAJ = new Node('Eastman Quad', null, 'EQPAJ', [EQPAJ_EQPAL, EQPAH_EQPAJ, EQPAJ_EQPAK], 'intersection', [43.1286454, -77.6289473], Math.min(), []);
    EQPAK = new Node('Eastman Quad', null, 'EQPAK', [EQPAK_RT01B, EQPAJ_EQPAK, EQPAK_WQPL], 'intersection', [43.1288719, -77.6291943], Math.min(), []);
    EQPAL = new Node('Eastman Quad', null, 'EQPAL', [EQPAJ_EQPAL, EQPAL_WC03B, EQPAL_EQPE], 'intersection', [43.1285401, -77.6292292], Math.min(), []);
    WQPI = new Node('Wilson Quad', null, 'WQPI', [WQPI_WQPJ, WQPI_WQPP, WQPC_WQPI], 'intersection', [43.1291383, -77.6300524], Math.min(), []);
    WQPJ = new Node('Wilson Quad', null, 'WQPJ', [WQPJ_WQPK, WQPI_WQPJ], 'intersection', [43.1292371, -77.6297858], Math.min(), []);
    WQPK = new Node('Wilson Quad', null, 'WQPK', [WQPK_WQPN, WQPK_WQPL, WQPJ_WQPK], 'intersection', [43.1293217, -77.6295629], Math.min(), []);
    WQPL = new Node('Wilson Quad', null, 'WQPL', [WQPK_WQPL, EQPAK_WQPL, WQPL_WQPN, WQPL_WQPM], 'intersection', [43.1291335, -77.6294231], Math.min(), []);
    WQPM = new Node('Wilson Quad', null, 'WQPM', [WQPM_WQPO, WQPM_WQPN, DG01A_WQPM, WQPL_WQPM], 'intersection', [43.1295769, -77.6288789], Math.min(), []);
    WQPN = new Node('Wilson Quad', null, 'WQPN', [WQPM_WQPN, WQPK_WQPN, DG01A_WQPN, WQPL_WQPN], 'intersection', [43.1294828, -77.6291499], Math.min(), []);
    WQPO = new Node('Wilson Quad', null, 'WQPO', [EQPAG_WQPO, WQPM_WQPO], 'intersection', [43.1296668, -77.6286361], Math.min(), []);
    WQPP = new Node('Wilson Quad', null, 'WQPP', [WQPI_WQPP, WC02A_WQPP, WQPP_WQPQ], 'intersection', [43.128898, -77.6301587], Math.min(), []);
    WQPQ = new Node('Wilson Quad', null, 'WQPQ', [WQPG_WQPQ, RT01A_WQPQ, WQPP_WQPQ], 'intersection', [43.1287193, -77.6302396], Math.min(), []);
    
    var all_nodes = [BR00A, BR01A, BR01B, BR01C, BR00, BR01, BR02, BR03, RT01A, RT01B, RT01C, RT01, RT02, RT03, MR02A, MR02B, MR03A, MR03B, MR03C, MRG, MR01, MR02, MR03, MR04, MR05, RRGA, RRGB, RRGC, RR01A, RR01B, RRG, RR01, RR02, RR03, RR04, EQPA, EQPB, EQPC, EQPD, EQPE, EQPF, EQPG, WQPA, WQPB, WQPC, WQPD, WQPE, WQPF, WQPG, WQPH, BL01, BL02, BL03, BL04, BL05, BL01A, BL01B, BL01C, BL02A, DWB, DW01, DW02, DW03, DW04, DW05, DW01A, DW01B, DW01C, DW01D, DW02A, HT01, HT02, HT01A, HT01B, HT01C, HT01D, HT01E, HT01F, HT02A, LT01, LT02, LT03, LT04, LT05, LT01A, LT02A, LT03A, IF01, IF02, IF03, IF01A, IF01B, IF03A, EQPH, EQPI, EQPJ, EQPK, EQPL, EQPM, EQPN, EQPO, EQPP, EQPQ, EQPR, ML01, ML02, ML03, ML04, ML02A, ML02B, ML03A, ML03B, EQPS, EQPT, EQPU, EQPV, EQPW, EQPX, EQPY, EQPZ, EQPAA, EQPAB, EQPAC, EQPAD, EQPAE, EQPAF, DG01, DG02, DG03, DG04, DG01A, DG02A, DG02B, DG02C, DG03A, WC01, WC02, WC03, WC04, WC05, WC02A, WC02B, WC03A, WC03B, WC04A, HUB, HU01, HU02, HU03, HU04, HL01, HL02, HL03, HL04, HL05, HL06, HL07, HL08, HL09, HL10, HL11, HU01A, HU02A, HL01A, HL02A, CL01, CL02, CL03, CS02, CS04, CS05, CS06, CS07, GR01, GR02, GR03, GR04, GR05, WM01, WM02, WM03, WM04, WM05, CS02A, CL01A, CL02A, CL02B, CL03A, GR01A, GR01B, GR01C, GR02A, WM01A, SQPA, SQPB, SQPC, SQPD, SQPE, SQPF, SQPG, SQPH, SQPI, SQPJ, SQPK, SQPL, SQPM, SQPN, SQPO, SQPP, SQPQ, SQPR, SQPS, SQPT, SQPU, SQPV, SQPW, SQPX, SQPY, SQPZ, EQPAG, EQPAH, EQPAI, EQPAJ, EQPAK, EQPAL, WQPI, WQPJ, WQPK, WQPL, WQPM, WQPN, WQPO, WQPP, WQPQ]
